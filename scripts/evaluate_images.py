...
ds_real = ImageFolder(
    "/projects/COMPXR/pranay/Eyes/Datasets/OCT/zipped_data/OCT_Test_512",
    transform=pil2torch,
)
# ds_fake = ImageFolder('/mnt/hdd/datasets/chest/CheXpert/ChecXpert-v10/generated_progan/', transform=pil2torch)
ds_fake = ImageFolder(
    "//projects/COMPXR/pranay/Eyes/Datasets/Diff_Generated_experiment_fid_50k",
    transform=pil2torch,
)
...
dm_real = DataLoader(
    ds_real, batch_size=batch_size, num_workers=8, shuffle=False, drop_last=False
)
dm_fake = DataLoader(
    ds_fake, batch_size=batch_size, num_workers=8, shuffle=False, drop_last=False
)
