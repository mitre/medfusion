...
# ---------------- Dataset/Dataloader ----------------
ds_real = ImageFolder(
    "/projects/COMPXR/pranay/Eyes/Datasets/OCT/zipped_data", transform=pil2torch
)
...
model = VAE.load_from_checkpoint(
    "/projects/COMPXR/pranay/Eyes/medfusion/runs/2024_01_19_154857/last.ckpt"
)
model.to(device)
