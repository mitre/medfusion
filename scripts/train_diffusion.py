...
if __name__ == "__main__":
    ...
    ds_4 = RFMID_Dataset(
        "/projects/NEI/pranay/Eyes/Datasets/A. RFMiD_All_Classes_Dataset/1. Original Images Processed 5/a. Training Set",
        "/projects/NEI/pranay/Eyes/Datasets/A. RFMiD_All_Classes_Dataset/2. Groundtruths/a. RFMiD_Training_Labels_mod.csv",
        crawler_ext="png",
    )
    ds_4_val = RFMID_Dataset(
        "/projects/NEI/pranay/Eyes/Datasets/A. RFMiD_All_Classes_Dataset/1. Original Images Processed 5/b. Validation Set",
        "/projects/NEI/pranay/Eyes/Datasets/A. RFMiD_All_Classes_Dataset/2. Groundtruths/b. RFMiD_Validation_Labels_mod.csv",
        crawler_ext="png",
    )
    ...
    cond_embedder_kwargs = {"emb_dim": 1024, "num_classes": 46}
    ...
    latent_embedder_checkpoint = (
        "/projects/NEI/pranay/Eyes/medfusion/runs/2024_03_08_142013/last.ckpt"
    )
    ...
    tensorboard_logger = TensorBoardLogger(
        "tb_logs", name="train_diff_RFMID_preprocessed_1024_actually"
    )
